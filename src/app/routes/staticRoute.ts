...
staticRoute.use('/react', serveStatic(path.join(app.rootPath, 'node_modules/react/umd/')));
//staticRoute.use('/react', serveStatic(path.join(app.rootPath, 'node_modules/react-dom/dist/')));
staticRoute.use('/react', serveStatic(path.join(app.rootPath, 'node_modules/react-dom/umd/')));

...
class FeedbackItem extends React.Component <any, any> {
	...
	render(){
		const feedbackLinks = this.props.feedback.links.map((feedbackLink, index)=>{
				return (
			...
			<div className="feedback-item">
				...
				<div className="row expanded article-url-section">
					<div className="small-12">
						<a className="article-url-link" href={feedback.article.url.href} target="_blank">
							{feedback.article.url.href}
						</a>
					</div>
				</div>
